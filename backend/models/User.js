...
module.exports = (sequelize) => {
  const User = sequelize.define('User', {
    ...
    banner: { type: DataTypes.STRING, allowNull: true, defaultValue: null},
    opis: { type: DataTypes.STRING, allowNull: true, defaultValue: null },
  ...
  User.associate = (models) => {
    ...
    User.hasMany(models.Message, { foreignKey: 'from_id', onDelete: 'cascade' });
    User.hasMany(models.Message, { foreignKey: 'to_id', onDelete: 'cascade' });
